...
public class AgenteIDAStar extends AbstractPlayer{
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
		...
		if(!empieza) {
			empieza = true;
			IDAStar ida = new IDAStar(stateObs);
			
	        long tInicio = System.nanoTime();
	        ruta = ida.IDAstar(inicial, objetivo);
	        ...
	        System.out.println("Nodos expandidos: " + ida.nodosexpandidos);
	        System.out.println("Nodos en memoria: " + ida.maximoNodos);
